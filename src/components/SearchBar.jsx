function SearchBar() {
  ...
  return (
    <form className="mx-auto max-w-lg pt-20">
      <div className="flex">
        <label
        ...
        <button
          ...
          className="z-10 inline-flex flex-shrink-0 items-center rounded-s-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-700"
          type="button"
        >
          Semua Generasi{" "}
          <svg
        ...
        <div className="relative w-full">
          <input
            ...
            placeholder="Cari NIS, Nama Lomba, Juara..."
            required
          />
          <button
            type="submit"
